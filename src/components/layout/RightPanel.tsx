...
const RightPanel = () => (
  <aside className="flex w-72 flex-col items-center border-l bg-white p-6 overflow-y-auto">
    <span className="self-start rounded-full bg-theme-coral px-4 py-1 text-xs font-semibold text-white">
      FREE
    </span>
    ...
    <div className="mt-10 w-full rounded-2xl bg-theme-light-100 p-6 pt-13 relative text-center">
     <img src={Folder} alt="Folder" className='mx-auto absolute left-1/2 -translate-x-1/2 -top-8 size-16 object-contain' />
